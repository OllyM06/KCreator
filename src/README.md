...
KCreator is a development tool designed to help you create mods for **Kerbal Space Program (KSP)**.

It turns the messy parts of mod development into a clean, structured workflow so you can focus more on building and less on setup headaches.
...
- 🗂️ Manage mod structure and components
- ⚡ Speed up repetitive setup tasks
- 🛠️ Keep your project clean and organised
...
- 🚀 Anyone who wants to bring ideas into KSP
...
Best if you want full control and plan to modify the tool.

```bash
git clone https://github.com/OllyM06/KCreator.git
cd KCreator
...
Every mod made using KCreator must include credit somewhere visible:

> Created with KCreator by OllyM06
...
requirements.txt is only required if you are running KCreator from the source code (GitHub clone).

If you are using the prebuilt `.exe` version from the official website or GitHub Releases, **no installation or dependencies are needed**. Everything is already included and ready to run. 🎉

However, if you are using the source code, to install the requirements use:
...
- 🧪 GitHub repo → development builds (latest features)
- 🌐 Website → packaged user-friendly version
- 📦 Releases → stable tested versions
